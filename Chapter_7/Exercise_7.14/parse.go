/*
* Определите новый конкретный тип, который соответствует
* интерфейсу Expr и предоставляет новую операцию, такую
* как вычисление минимального значения ее операндов.
* Поскольку функция Parse не создает экземпляров этого
* нового типа, для ее применения вам надо строить синтактическое
* дерево непосредственно (или расширять синтактический анализатор).
 */
