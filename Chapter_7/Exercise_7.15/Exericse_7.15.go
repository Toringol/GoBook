/*
* Напишите программу, которая читает из
* стандартного ввода единсвенное выражение,
* предлагает пользователю ввести значение переменных,
* а затем вычисляет выражение в полученной среде.
...
import (
	...
	eval "github.com/adonovan/gopl.io/ch7/eval"
)
